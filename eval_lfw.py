...
def main():
    ...
    parser.add_argument('-d', '--dataset_path',
                        default='/home/jameson/face_similarity/siamese_density_networks/data/LFW_DIR/lfw-deepfunneled')
    parser.add_argument('--fold', type=int, default=0, choices=[0, 10])
    parser.add_argument('--batch_size', type=int, default=100)
    parser.add_argument('-m', '--model_path',
                        default='/home/jameson/face_similarity/siamese_density_networks/data/LFW_DIR/model',
    ...
    if args.fold == 0:
        pairs_path = root_path + 'pairsDevTest.txt'
    else:
        pairs_path = root_path + 'pairs.txt'
